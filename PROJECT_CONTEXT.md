...
| 궁금해요 | `vote` | 투표·수요조사 | 2026-08-01 신설. 빈 게시판으로 시작, `CATMAP`에 `투표`(chal-c) 추가. **2026-08-02 이야기→궁금해요 이동** |
...
| 그리는 중 | `doodle` | 낙서/자유 그림 | **2026-08-02 신설(그리는 중 그룹 상단)**. 부담 없는 낙서/자유 그림용. `CATMAP`에 `낙서`(talk-c), 말머리 없음 |
