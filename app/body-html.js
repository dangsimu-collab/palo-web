...
<div class="catbar" id="catbar">
  <div class="wrap"><div class="catbar-inner" id="chips"><button class="chip on" onclick="selectBoard('all')">전체 글</button><button class="chip" onclick="selectBoard('talk')">수다 광장</button><button class="chip" onclick="selectBoard('ask')">질문/시세문의</button><button class="chip" onclick="selectBoard('vote')">투표·수요조사</button><button class="chip" onclick="selectBoard('wip')">작업 과정</button><button class="chip" onclick="selectBoard('crit')">피드백 요청</button><button class="chip" onclick="selectBoard('sketch')">그림공부</button><button class="chip" onclick="selectBoard('challenge')">챌린지</button><button class="chip" onclick="selectBoard('tip')">자료·TIP 공유</button><button class="chip" onclick="selectBoard('request')">리퀘스트</button><button class="chip" onclick="selectBoard('recruit')">커미션 구인</button><button class="chip" onclick="selectBoard('used')">중고 장비</button></div></div>
</div>
<div class="trendbar">
